const byPassedRoutes = ['/v1/cron/conversion/rate/','/v1/admin/staff/create','/v1/front/test','/v1/front/auth/login','/v1/admin/staff/login','/v1/front/auth/register','/v1/front/auth/login','/v1/front/auth/forgot-password','/v1/front/auth/reset-password','/v1/mobile/auth/signin','/v1/mobile/auth/signup','/v1/mobile/auth/forgot-password','/v1/front/games/get-games'];
